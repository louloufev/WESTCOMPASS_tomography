...
dr_grid = 50e-3 #radius step of 2D grid
dz_grid = 50e-3 #height step of 2D grid
...
params_fit = ['vid', 'camera', 'mask'] # 
Verbose = True #if set to True, will plot additionnal plots along the raytracing process to vizualize if the process runs well
